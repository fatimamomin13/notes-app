...
const Modal = (props) => {
  ...
  return (
    <>
      <div className="flex justify-center items-center overflow-x-hidden overflow-y-auto fixed inset-0 z-50 outline-none focus:outline-none bg-gray-200">
        <div className="border-0 rounded-lg shadow-lg relative w-10/12 flex flex-col bg-white outline-none focus:outline-none">
